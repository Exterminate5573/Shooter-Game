...
public class PlayerController : NetworkBehaviour
{
    ...
    private void Start()
    {
        playerScale =  _transform.transform.localScale;
    }
    ...
    private void StartCrouch() {
        _transform.transform.localScale = crouchScale;
        _transform.transform.position = new Vector3(_transform.transform.position.x, _transform.transform.position.y - 0.5f, _transform.transform.position.z);
    ...
    private void StopCrouch() {
        _transform.transform.localScale = playerScale;
        _transform.transform.position = new Vector3(_transform.transform.position.x, _transform.transform.position.y + 0.5f, _transform.transform.position.z);
    }
